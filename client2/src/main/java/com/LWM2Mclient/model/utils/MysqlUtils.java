...
public class MysqlUtils {
    ...
    static String URL = "jdbc:mysql://localhost:3306/"+ PropertiesUtils.getProperty("databaseName")+"?serverTimezone=GMT";
    static String USERNAME = PropertiesUtils.getProperty("databaseUser");
    static String PASSWORD = PropertiesUtils.getProperty("databasePwd");
